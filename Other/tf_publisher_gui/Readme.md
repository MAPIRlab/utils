...
The resulting TF is published at 30Hz. Once you have correctly adjusted the transformation params, you can also run the node without the GUI by setting the `render` ROS param to `false`.